...
def main():
    ...
    print('hudCreatures', hudCreatures, len(hudCreatures))   
    ...
    content = battleList.extractors.getContent(grayScreenshot)
    filledSlotsCount = battleList.extractors.getFilledSlotsCount(content)
    res = timeit.repeat(lambda: battleList.extractors.getBeingAttackedCreatures(content, filledSlotsCount), repeat=10, number=1)
    print('res', res)
    # print(hud.creatures.getCreaturesBars(hudImg))
