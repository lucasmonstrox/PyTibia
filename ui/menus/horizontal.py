...
class HorizontalMenu(BoxLayout):
    def __init__(self, **kwargs):
        ...
        targetButton = Button(text='Target', size_hint=(None, 1))
        targetButton.bind(on_press=lambda _: self.parent.ids.screen_manager.switch_screen('target_screen'))
        
        healerButton = Button(text='Healer', size_hint=(None, 1))
        healerButton.bind(on_press=lambda _: self.parent.ids.screen_manager.switch_screen('healer_screen'))
