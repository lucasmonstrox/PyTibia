...
from src.utils.image import crop, load, loadAsGrey
from src.utils.mouse import mouseDrag, rightClick


currentPath = pathlib.Path(__file__).parent.resolve()
backpackBarImg = loadAsGrey(f'{currentPath}/images/backpackBar.png')
...
mainBackpackImg = loadAsGrey(f'{currentPath}/images/mainBackpack.png')
...
itemsImgs = [
    ...
    ('great-mana-potion', load(f'{currentPath}/images/items/great-mana-potion.png')),
    ('great-spirit-potion',
     load(f'{currentPath}/images/items/great-spirit-potion.png')),
    ('health-potion', load(f'{currentPath}/images/items/health-potion.png')),
    ('mana-potion', load(f'{currentPath}/images/items/mana-potion.png')),
    ('strong-health-potion',
     load(f'{currentPath}/images/items/strong-health-potion.png')),
    ('strong-mana-potion', load(f'{currentPath}/images/items/strong-mana-potion.png')),
    ('ultimate-health-potion',
    ...
    ('brown-backpack', load(f'{currentPath}/images/items/brown-backpack.png')),
    ('blue-backpack', load(f'{currentPath}/images/items/blue-backpack.png')),
    ('orange-backpack', load(f'{currentPath}/images/items/orange-backpack.png')),
    ('jewelled-backpack', load(f'{currentPath}/images/items/jewelled-backpack.png')),
    ('shopping-bag', load(f'{currentPath}/images/items/shopping-bag.png')),
    ('depot-chest-1', load(f'{currentPath}/images/items/depot-chest-1.png')),
    ('depot-chest-2', load(f'{currentPath}/images/items/depot-chest-2.png')),
    ('depot-chest-3', load(f'{currentPath}/images/items/depot-chest-3.png')),
    ('depot-chest-4', load(f'{currentPath}/images/items/depot-chest-4.png')),
    ('depot-chest-5', load(f'{currentPath}/images/items/depot-chest-5.png')),
    ('depot-chest-6', load(f'{currentPath}/images/items/depot-chest-6.png')),
    ('depot-chest-7', load(f'{currentPath}/images/items/depot-chest-7.png')),
    ('depot-chest-8', load(f'{currentPath}/images/items/depot-chest-8.png')),
    ('depot-chest-9', load(f'{currentPath}/images/items/depot-chest-9.png')),
    ('depot-chest-10', load(f'{currentPath}/images/items/depot-chest-10.png')),
    ('depot-chest-11', load(f'{currentPath}/images/items/depot-chest-11.png')),
    ('depot-chest-12', load(f'{currentPath}/images/items/depot-chest-12.png')),
    ('depot-chest-13', load(f'{currentPath}/images/items/depot-chest-13.png')),
    ('depot-chest-14', load(f'{currentPath}/images/items/depot-chest-14.png')),
    ('depot-chest-15', load(f'{currentPath}/images/items/depot-chest-15.png')),
    ('depot-chest-16', load(f'{currentPath}/images/items/depot-chest-16.png')),
    ('depot-chest-17', load(f'{currentPath}/images/items/depot-chest-17.png')),
    ('depot-chest-18', load(f'{currentPath}/images/items/depot-chest-18.png')),
