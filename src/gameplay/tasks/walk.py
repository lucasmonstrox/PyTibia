...
class WalkTask(BaseTask):
    ...
    def shouldIgnore(self, context):
        ...
        if context['lastCoordinateVisited'] is None:
            return True
        isStartingFromLastCoordinate = context['radar']['coordinate'][0] != context['lastCoordinateVisited'][0] and context['radar']['coordinate'][1] != context['lastCoordinateVisited'][1] and context['radar']['coordinate'][2] != context['lastCoordinateVisited'][2]
