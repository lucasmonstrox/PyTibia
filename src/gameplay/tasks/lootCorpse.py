...
class LootCorpseTask(BaseTask):
    ...
    def do(self, context):
        ...
        pyautogui.keyDown('shift')
        rightClickSlot([6, 4], context['hud']['coordinate'])
        rightClickSlot([7, 4], context['hud']['coordinate'])
        rightClickSlot([8, 4], context['hud']['coordinate'])
        rightClickSlot([6, 5], context['hud']['coordinate'])
        rightClickSlot([7, 5], context['hud']['coordinate'])
        rightClickSlot([8, 5], context['hud']['coordinate'])
        rightClickSlot([6, 6], context['hud']['coordinate'])
        rightClickSlot([7, 6], context['hud']['coordinate'])
        rightClickSlot([8, 6], context['hud']['coordinate'])
